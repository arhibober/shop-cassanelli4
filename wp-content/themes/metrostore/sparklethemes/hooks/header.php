				          	...
				          	<?php if (is_user_logged_in()) { ?>	
					          	...
					          	<div class="myaccount">
					          		<a title="My Account" href="<?php echo esc_url(get_permalink(get_option('woocommerce_myaccount_page_id'))); ?>">
					          			...
					          			<span><?php esc_html_e('Мой аккаунт', 'metrostore'); ?></span>
					          		</a>
					          	</div>
					          	...
					          	<div class="login">
					          		<a href="<?php echo esc_url(wp_logout_url(home_url())); ?>">
					          			...
					          			<span><?php esc_html_e('Выйти', 'metrostore'); ?></span>
					          		</a>
					          	</div>
				          	...
				          	<?php } else{ ?>
					            ...
					            <div class="login">
					          		<a href="<?php echo esc_url(get_permalink(get_option('woocommerce_myaccount_page_id'))); ?>">
					          			...
					          			<span><?php esc_html_e('Войти', 'metrostore'); ?></span>
					          		</a>
					          	</div>
					          	...
					          	<div class="login">
						          	<a href="<?php echo esc_url(get_permalink(get_option('woocommerce_myaccount_page_id'))); ?>">
							          	<i class="fa fa-user"></i>
							          	<span><?php esc_html_e('Зарегистрироваться', 'metrostore'); ?></span>
							        </a>
					          	</div>
			              ...
			              <div class="mini-cart">
			                ...
			                <div>
			                    <div class="top-cart-content">
			                    	<div class="block-subtitle"><?php esc_html_e('Недавно добавленный(е) товар(ы)','metrostore'); ?></div>
